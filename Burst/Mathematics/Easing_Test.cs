...
namespace SatorImaging.UnityFundamentals
{
    public static class Easing_Test
    {
        ...
        private static readonly Dictionary<string, float[]> ExpectedValues = new Dictionary<string, float[]>
        {
            ...
            { "CircIn", new float[] { -0.0000001f, 0.0049980f, 0.0201934f, 0.0453534f, 0.0817497f, 0.1329089f, 0.1996570f, 0.2846900f, 0.3994372f, 0.5635226f, 1.0000000f } },
            { "CircInOut", new float[] { -0.0000001f, 0.0100967f, 0.0408748f, 0.0998285f, 0.1997186f, 0.5000000f, 0.8002815f, 0.9001715f, 0.9591252f, 0.9899033f, 1.0000000f } },
            { "CircOut", new float[] { 0.0000000f, 0.4364775f, 0.6005628f, 0.7153100f, 0.8003430f, 0.8670911f, 0.9182503f, 0.9546466f, 0.9798066f, 0.9950020f, 1.0000001f } },
            ...
            { "SineIn", new float[] { 0.0000000f, 0.0128053f, 0.0494656f, 0.1093748f, 0.1912053f, 0.2929983f, 0.4122535f, 0.5460194f, 0.6909844f, 0.8435656f, 1.0000000f } },
            ...
            { "SineOut", new float[] { 0.0000000f, 0.1564344f, 0.3090156f, 0.4539806f, 0.5877466f, 0.7070017f, 0.8087947f, 0.8906252f, 0.9505344f, 0.9871947f, 1.0000000f } },
        };
    }
}
