...
namespace SatorImaging.UnityFundamentals
{
    public static class Easing_Test
    {
        ...
        private static readonly Dictionary<string, float[]> ExpectedValues = new Dictionary<string, float[]>
        {
            ...
            { "CircIn", new float[] { 0.0000000f, 0.0067516f, 0.0219213f, 0.0470187f, 0.0834870f, 0.1346595f, 0.2013116f, 0.2860957f, 0.4006454f, 0.5643993f, 1.0000000f } },
            { "CircInOut", new float[] { 0.0000000f, 0.0109606f, 0.0417435f, 0.1006558f, 0.2003227f, 0.5000000f, 0.7996773f, 0.8993442f, 0.9582565f, 0.9890394f, 1.0000000f } },
            { "CircOut", new float[] { 0.0000000f, 0.4356007f, 0.5993546f, 0.7139043f, 0.7986884f, 0.8653405f, 0.9165130f, 0.9529813f, 0.9780787f, 0.9932484f, 1.0000000f } },
            ...
            { "SineIn", new float[] { 0.0000000f, 0.0101334f, 0.0479829f, 0.1086143f, 0.1908535f, 0.2928569f, 0.4122071f, 0.5460085f, 0.6909829f, 0.8435655f, 1.0000000f } },
            { "SineInOut", new float[] { 0.0000000f, 0.0239914f, 0.0954268f, 0.2061036f, 0.3454915f, 0.5000000f, 0.6545085f, 0.7938964f, 0.9045732f, 0.9760086f, 1.0000000f } },
            { "SineOut", new float[] { 0.0000000f, 0.1564345f, 0.3090171f, 0.4539915f, 0.5877929f, 0.7071431f, 0.8091465f, 0.8913857f, 0.9520171f, 0.9898666f, 1.0000000f } },
        };
    }
}
