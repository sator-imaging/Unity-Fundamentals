...
namespace SatorImaging.UnityFundamentals
{
    public static class Easing_Test
    {
        ...
        {
            // BackIn: 0.0, -0.014314220000000004, -0.046450560000000016, -0.08019954000000003, -0.09935168000000005, -0.08769750000000004, -0.029027519999999973, 0.09286773999999998, 0.29419775999999986, 0.5911720200000001, 0.9999999999999998
            { "BackIn", new double[] { 0, -0.01431422, -0.04645056, -0.08019954, -0.09935168, -0.0876975, -0.02902752, 0.09286774, 0.29419776, 0.59117202, 1 } },
            // BackInOut: -0.0, -0.037518552000000004, -0.092555656, -0.07883348399999993, 0.0899257920000001, 0.5, 0.9100742080000003, 1.078833484, 1.092555656, 1.0375185519999999, 1.0
            ...
            // BackOut: 2.220446049250313e-16, 0.40882797999999987, 0.7058022400000001, 0.9071322600000001, 1.02902752, 1.0876975, 1.09935168, 1.08019954, 1.04645056, 1.01431422, 1.0
            { "BackOut", new double[] { 0, 0.40882798, 0.70580224, 0.90713226, 1.02902752, 1.0876975, 1.09935168, 1.08019954, 1.04645056, 1.01431422, 1 } },
            // BounceIn: 0.0, 0.01187500000000008, 0.06000000000000005, 0.06937499999999996, 0.22750000000000004, 0.234375, 0.08999999999999986, 0.3193750000000003, 0.6975000000000001, 0.9243750000000001, 1.0
            { "BounceIn", new double[] { 0, 0.011875, 0.06, 0.069375, 0.2275, 0.234375, 0.09, 0.319375, 0.6975, 0.924375, 1 } },
            // BounceInOut: 0.0, 0.030000000000000027, 0.11375000000000002, 0.04499999999999993, 0.34875000000000006, 0.5, 0.6512500000000003, 0.9549999999999998, 0.88625, 0.97, 1.0
            { "BounceInOut", new double[] { 0, 0.03, 0.11375, 0.045, 0.34875, 0.5, 0.65125, 0.955, 0.88625, 0.97, 1 } },
            // BounceOut: 0.0, 0.07562500000000001, 0.30250000000000005, 0.6806250000000001, 0.9099999999999999, 0.765625, 0.7725000000000001, 0.9306250000000003, 0.94, 0.9881249999999999, 1.0
            { "BounceOut", new double[] { 0, 0.075625, 0.3025, 0.680625, 0.91, 0.765625, 0.7725, 0.930625, 0.94, 0.988125, 1 } },
            // CircIn: 0.0, 0.005012562893380035, 0.020204102886728803, 0.04606079858305434, 0.08348486100883201, 0.1339745962155614, 0.20000000000000007, 0.285857157145715, 0.40000000000000013, 0.5641101056459328, 1.0
            ...
            // CircInOut: 0.0, 0.010102051443364402, 0.041742430504416006, 0.10000000000000003, 0.20000000000000007, 0.5, 0.8000000000000002, 0.9, 0.958257569495584, 0.9898979485566356, 1.0
            ...
            // CircOut: 0.0, 0.4358898943540673, 0.5999999999999999, 0.714142842854285, 0.8, 0.8660254037844386, 0.9165151389911681, 0.9539392014169457, 0.9797958971132712, 0.99498743710662, 1.0
            ...
            // CubicIn: 0.0, 0.0010000000000000002, 0.008000000000000002, 0.027000000000000014, 0.06400000000000002, 0.125, 0.2160000000000001, 0.3430000000000001, 0.5120000000000001, 0.7290000000000001, 1.0
            { "CubicIn", new double[] { 0, 0.001, 0.008, 0.027, 0.064, 0.125, 0.216, 0.343, 0.512, 0.729, 1 } },
            // CubicInOut: 0.0, 0.004000000000000001, 0.03200000000000001, 0.10800000000000005, 0.25600000000000006, 0.5, 0.7440000000000002, 0.8920000000000001, 0.968, 0.996, 1.0
            { "CubicInOut", new double[] { 0, 0.004, 0.032, 0.108, 0.256, 0.5, 0.744, 0.892, 0.968, 0.996, 1 } },
            // CubicOut: 0.0, 0.2709999999999999, 0.4879999999999999, 0.657, 0.784, 0.875, 0.936, 0.973, 0.992, 0.999, 1.0
            { "CubicOut", new double[] { 0, 0.271, 0.488, 0.657, 0.784, 0.875, 0.936, 0.973, 0.992, 0.999, 1 } },
            // ElasticIn: 0, 0.001953125, -0.0019531250000000126, -0.0039062499999999918, 0.015625, -0.015625000000000045, -0.03124999999999987, 0.12500000000000008, -0.1250000000000001, -0.24999999999999986, 1
            { "ElasticIn", new double[] { 0, 0.001953125, -0.001953125, -0.00390625, 0.015625, -0.015625, -0.03125, 0.125, -0.125, -0.25, 1 } },
            // ElasticInOut: 0, 0.000339156597005722, -0.0039062499999999935, 0.023938888847468056, -0.11746157759823853, 0.5, 1.1174615775982386, 0.9760611111525319, 1.00390625, 0.9996608434029943, 1
            ...
            // ElasticOut: 0, 1.25, 1.125, 0.875, 1.03125, 1.015625, 0.984375, 1.00390625, 1.001953125, 0.998046875, 1
            { "ElasticOut", new double[] { 0, 1.25, 1.125, 0.875, 1.03125, 1.015625, 0.984375, 1.00390625, 1.001953125, 0.998046875, 1 } },
            // ExpoIn: 0, 0.001953125, 0.00390625, 0.0078125, 0.015625, 0.03125, 0.06250000000000004, 0.12500000000000008, 0.25, 0.5, 1.0
            { "ExpoIn", new double[] { 0, 0.001953125, 0.00390625, 0.0078125, 0.015625, 0.03125, 0.0625, 0.125, 0.25, 0.5, 1 } },
            // ExpoInOut: 0, 0.001953125, 0.0078125, 0.03125000000000002, 0.125, 0.5, 0.8750000000000001, 0.96875, 0.9921875, 0.998046875, 1
            { "ExpoInOut", new double[] { 0, 0.001953125, 0.0078125, 0.03125, 0.125, 0.5, 0.875, 0.96875, 0.9921875, 0.998046875, 1 } },
            // ExpoOut: 0.0, 0.5, 0.75, 0.875, 0.9375, 0.96875, 0.984375, 0.9921875, 0.99609375, 0.998046875, 1
            { "ExpoOut", new double[] { 0, 0.5, 0.75, 0.875, 0.9375, 0.96875, 0.984375, 0.9921875, 0.99609375, 0.998046875, 1 } },
            // QuadIn: 0.0, 0.010000000000000002, 0.04000000000000001, 0.09000000000000002, 0.16000000000000003, 0.25, 0.3600000000000001, 0.4900000000000001, 0.6400000000000001, 0.81, 1.0
            { "QuadIn", new double[] { 0, 0.01, 0.04, 0.09, 0.16, 0.25, 0.36, 0.49, 0.64, 0.81, 1 } },
            // QuadInOut: 0.0, 0.020000000000000004, 0.08000000000000002, 0.18000000000000005, 0.32000000000000006, 0.5, 0.6800000000000002, 0.8200000000000001, 0.92, 0.98, 1.0
            { "QuadInOut", new double[] { 0, 0.02, 0.08, 0.18, 0.32, 0.5, 0.68, 0.82, 0.92, 0.98, 1 } },
            // QuadOut: 0.0, 0.18999999999999995, 0.3599999999999999, 0.51, 0.64, 0.75, 0.8400000000000001, 0.91, 0.96, 0.99, 1.0
            { "QuadOut", new double[] { 0, 0.19, 0.36, 0.51, 0.64, 0.75, 0.84, 0.91, 0.96, 0.99, 1 } },
            // QuartIn: 0.0, 0.00010000000000000002, 0.0016000000000000003, 0.008100000000000005, 0.025600000000000005, 0.0625, 0.12960000000000008, 0.2401000000000001, 0.4096000000000001, 0.6561, 1.0
            { "QuartIn", new double[] { 0, 0.0001, 0.0016, 0.0081, 0.0256, 0.0625, 0.1296, 0.2401, 0.4096, 0.6561, 1 } },
            // QuartInOut: 0.0, 0.0008000000000000001, 0.012800000000000002, 0.06480000000000004, 0.20480000000000004, 0.5, 0.7952000000000001, 0.9352, 0.9872, 0.9992, 1.0
            { "QuartInOut", new double[] { 0, 0.0008, 0.0128, 0.0648, 0.2048, 0.5, 0.7952, 0.9352, 0.9872, 0.9992, 1 } },
            // QuartOut: 0.0, 0.3439, 0.5903999999999999, 0.7599, 0.8704000000000001, 0.9375, 0.9744, 0.9919, 0.9984, 0.9999, 1.0
            { "QuartOut", new double[] { 0, 0.3439, 0.5904, 0.7599, 0.8704, 0.9375, 0.9744, 0.9919, 0.9984, 0.9999, 1 } },
            // QuintIn: 0.0, 1.0000000000000003e-05, 0.0003200000000000001, 0.0024300000000000016, 0.010240000000000003, 0.03125, 0.07776000000000005, 0.16807000000000008, 0.3276800000000001, 0.5904900000000001, 1.0
            ...
            // QuintInOut: 0.0, 0.00016000000000000004, 0.005120000000000001, 0.038880000000000026, 0.16384000000000004, 0.5, 0.8361600000000002, 0.9611200000000001, 0.99488, 0.99984, 1.0
            { "QuintInOut", new double[] { 0, 0.00016, 0.00512, 0.03888, 0.16384, 0.5, 0.83616, 0.96112, 0.99488, 0.99984, 1 } },
            // QuintOut: 0.0, 0.40950999999999993, 0.6723199999999999, 0.8319300000000001, 0.9222400000000001, 0.96875, 0.98976, 0.99757, 0.99968, 0.99999, 1.0
            { "QuintOut", new double[] { 0, 0.40951, 0.67232, 0.83193, 0.92224, 0.96875, 0.98976, 0.99757, 0.99968, 0.99999, 1 } },
            // SineIn: 0.0, 0.01231165940486223, 0.04894348370484647, 0.1089934758116321, 0.19098300562505255, 0.2928932188134524, 0.412214747707527, 0.5460095002604533, 0.6909830056250525, 0.843565534959769, 0.9999999999999999
            ...
            // SineInOut: -0.0, 0.024471741852423234, 0.09549150281252627, 0.2061073738537635, 0.3454915028125263, 0.49999999999999994, 0.6545084971874737, 0.7938926261462365, 0.9045084971874737, 0.9755282581475768, 1.0
            ...
            // SineOut: 0.0, 0.15643446504023087, 0.3090169943749474, 0.4539904997395468, 0.5877852522924731, 0.7071067811865475, 0.8090169943749475, 0.8910065241883678, 0.9510565162951535, 0.9876883405951378, 1.0
